  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (loginRes.ok) {
        ...
        toast("Compte créé avec succès ! Bienvenue sur Localizi.");
        ...
        <div className="sp-form-wrap">
          ...
          <form onSubmit={handleSubmit} className="sp-form">
            <div className="sp-field">
              ...
              <input
                type="text" className="sp-input" placeholder="votre_nom"
            ...
            <div className="sp-field">
              ...
              <div className="sp-pw-wrap">
                <input
                  type={showConfirm ? "text" : "password"} className="sp-input"
                  placeholder="••••••••" value={confirmPassword}
                  onChange={e => setConfirmPassword(e.target.value)}
                  required disabled={loading} autoComplete="new-password"
                />
                <button type="button" className="sp-eye" onClick={() => setShowConfirm(v => !v)} tabIndex={-1}>
          ...
          <p className="sp-switch">
            Déjà un compte ?{" "}
            <Link to="/login" className="sp-link">Se connecter</Link>
          </p>
        </div>
      </div>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sp-left__accent {
          ...
          background: linear-gradient(90deg, #6366f1, #818cf8, #a5b4fc); z-index: 3;
        }
        .sp-center-icon {
